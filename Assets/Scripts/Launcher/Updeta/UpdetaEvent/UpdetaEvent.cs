...
{
    public static class UpdetaEvent
    {
        ...
        {
            if (_isInitialize)
                throw new Exception($"{nameof(UpdetaEvent)} is initialized !");

            if (_isInitialize == false)
            {
                _isInitialize = true;
                LogUtlis.Info($"{nameof(UpdetaEvent)} initalize !");
            }
        }
        ...
        public static void Destroy()
        {
            if (_isInitialize)
            {
                ClearAll();
                _isInitialize = false;
                LogUtlis.Info($"{nameof(UpdetaEvent)} destroy all !");
            }
        }
